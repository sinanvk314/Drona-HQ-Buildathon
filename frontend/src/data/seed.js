// MOCK-ONLY: seed data for the demo. Replaced by backend REST responses later.
// Only src/services/* may import this file. Screens must go through src/services/api.js.
...
export function buildSeed(now) {
  ...
  const sources = () => [
    { id: "s1", name: "NimbusGuard — Product One-Pager.pdf", category: "Product info" },
    { id: "s2", name: "Case Study — Infra Cost Savings at Scale.pdf", category: "Case study" },
    { id: "s3", name: "Objection Handling Playbook — Founders.pdf", category: "Objections" },
  ];
  ...
  const campaigns = [
    {
      ...
      qualificationPrompt:
        "Qualify if the company is hiring cloud-cost or platform roles OR has raised in the last 12 months, and the contact is a CTO or VP Engineering.",
      dailyLimit: 60,
    ...
    },
    {
      ...
      qualificationPrompt:
        "Qualify if the entity is RBI-regulated and the contact owns technology or risk decisions.",
      dailyLimit: 30,
    ...
    },
    {
      ...
      icpText:
        "Founder or CEO at a seed–Series A voice / conversational AI startup, 5–60 employees, actively scaling infrastructure.",
      geography: ["United States"],
      ...
      channels: ["email", "sms"],
      qualificationPrompt:
        "Qualify if company is actively hiring infra/platform roles OR has raised a round in the last 6 months, and the contact's title matches Founder/CEO.",
      dailyLimit: 40,
      workingHours: "9:00 AM – 6:00 PM, prospect local time",
      approvals: { firstOutreach: true, meetingTime: false, escalate: true },
      sources: sources(),
  ...
  const prospects = [
    mk({
      id: "p_marcus", campaignId: "c_us_saas", name: "Marcus Lee", title: "CTO", company: "Acme Cloud",
      ...
      tech: ["AWS", "Kubernetes", "Datadog", "Terraform"],
      stage: "contacted", fit: 92, channel: "Email",
      lastAction: "Follow-up drafted, {ago}", lastTs: m(3), nextStep: "Awaiting approval",
      reasons: [
        "Matches target company size (50–500 employees)",
        "Role matches ICP persona (CTO)",
        'Recent hiring signal: "Platform Engineer, AWS cost optimisation"',
      ],
      qual: {
        status: "Qualified",
        reasoning: "Meets ICP on company size, role and buying signal; no exclusion criteria triggered.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(2),
      },
      evidence: [
        "Hiring: Platform Engineer (AWS cost)",
        "Uses Kubernetes (job postings)",
        "Attended KubeCon 2026",
        "Series B closed — Mar 2026",
      ],
      history: [
      ...
      conversation: [
        {
          dir: "out",
          text: "Hi Marcus — noticed Acme Cloud's been hiring for platform/AWS cost roles. Teams like Fleetwise cut cloud spend 23% in 60 days without slowing releases using NimbusGuard. Worth a quick look?",
          when: "Sep 15, 10:04 AM",
        },
        {
          dir: "in",
          text: "Interesting — tell me more about pricing and how it works with our existing Datadog setup.",
          when: "Today, 1:52 PM",
        },
      ],
    }),
    mk({
      id: "p_dana", campaignId: "c_us_saas", name: "Dana Priest", title: "VP Eng", company: "Fleetwise",
      email: "dana.priest@fleetwise.io", city: "Austin, TX", linkedin: "linkedin.com/in/danapriest",
      industry: "Logistics SaaS", size: "240 employees", funding: "Series C, $65M raised",
      tech: ["AWS", "Terraform", "Grafana"],
      stage: "qualified", fit: 88, channel: "—",
      lastAction: "Qualified, {ago}", lastTs: m(17), nextStep: "Personalise & send",
      reasons: ["Company size within the 50–500 range", "VP Eng is a target persona", "Existing NimbusGuard case-study logo"],
      qual: {
        status: "Qualified", reasoning: "Strong fit on size and persona; score 88/100.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: m(17),
      },
    ...
    mk({
      id: "p_wei", campaignId: "c_us_saas", name: "Wei Chen", title: "CTO", company: "CloudNet",
      email: "wei.chen@cloudnet.dev", city: "Seattle, WA", linkedin: "linkedin.com/in/weichen",
      industry: "Cloud networking", size: "320 employees", funding: "Series B, $38M raised",
      tech: ["GCP", "Kubernetes", "Prometheus"],
      stage: "engaged", fit: 81, channel: "Email",
      lastAction: "Objection raised, {ago}", lastTs: m(54), nextStep: "Human review",
      reasons: ["Within target company size", "CTO persona match", "Active infrastructure hiring"],
      qual: {
        status: "Qualified", reasoning: "Meets ICP; engaged after first email, then raised a compliance objection.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(30),
      },
    ...
    mk({
      id: "p_yuki", campaignId: "c_us_saas", name: "Yuki Tanaka", title: "CTO", company: "Northwind Data",
      email: "yuki.tanaka@northwinddata.com", city: "Denver, CO", linkedin: "linkedin.com/in/yukitanaka",
      industry: "Data infrastructure", size: "150 employees", funding: "Series B, $30M raised",
      tech: ["AWS", "Snowflake", "Datadog"],
      stage: "meeting", fit: 95, channel: "Email + LinkedIn",
      lastAction: "Meeting booked, Sep 24", lastTs: hrs(5), nextStep: "Prep for call",
      reasons: ["Ideal size and persona", "Recent cloud-cost hiring signal", "Replied within 2 hours"],
      qual: {
        status: "Qualified", reasoning: "Top-scoring prospect; meeting booked for Sep 24.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: days(3),
      },
    ...
    mk({
      id: "p_leah", campaignId: "c_us_saas", name: "Leah Ortiz", title: "VP Eng", company: "Byteform",
      email: "leah.ortiz@byteform.co", city: "Boston, MA", linkedin: "linkedin.com/in/leahortiz",
      industry: "Developer tools", size: "12 employees", funding: "Seed, $4M raised",
      tech: ["AWS", "Vercel"],
      stage: "researched", fit: null, channel: "—",
      lastAction: "Enriched, {ago}", lastTs: m(31), nextStep: "ICP scoring",
    ...
    mk({
      id: "p_alex", campaignId: "c_us_saas", name: "Alex Kim", title: "Founder", company: "Sana Corp",
      email: "alex@sanacorp.io", city: "Chicago, IL", linkedin: "linkedin.com/in/alexkim",
      industry: "Analytics SaaS", size: "9 employees", funding: "Pre-seed",
      tech: ["GCP"],
      stage: "rejected", fit: 34, channel: "—",
      lastAction: "Rejected — below ICP size, {ago}", lastTs: hrs(1), nextStep: "—",
      reasons: ["Company size is below the 50-employee threshold", "Persona is not in the target list"],
      qual: {
        status: "Rejected", reasoning: "Under 50 employees and outside the target persona.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(1),
      },
      evidence: ["9 employees (public profile)", "No cloud-cost hiring signal"],
    }),
    mk({
      id: "p_ananya", campaignId: "c_india_bfsi", name: "Ananya Rao", title: "CIO", company: "Vertex Bank",
      email: "ananya.rao@vertexbank.in", city: "Mumbai, IN", linkedin: "linkedin.com/in/ananyarao",
      industry: "Retail banking", size: "4,200 employees", funding: "Listed",
      tech: ["Azure", "Oracle", "ServiceNow"],
      stage: "meeting", fit: 90, channel: "Email",
      lastAction: "Meeting booked, Sep 24", lastTs: m(41), nextStep: "Prep for call",
      reasons: ["RBI-regulated entity", "CIO owns technology decisions", "Data-residency requirement matches the ICP"],
      qual: {
        status: "Qualified", reasoning: "Regulated bank with a clear data-residency need.",
        agent: "ICP Fitment Agent", harness: "harness v3.2", ts: days(4),
      },
    ...
    mk({
      id: "p_rajiv", campaignId: "c_india_bfsi", name: "Rajiv Menon", title: "Head of Risk", company: "Meridian Insurance",
      email: "rajiv.menon@meridianins.in", city: "Pune, IN", linkedin: "linkedin.com/in/rajivmenon",
      industry: "Insurance", size: "1,800 employees", funding: "Listed",
      tech: ["AWS", "Salesforce"],
      stage: "contacted", fit: 84, channel: "Email",
      lastAction: "Opening email sent, {ago}", lastTs: hrs(4), nextStep: "Awaiting reply",
    ...
    mk({
      id: "p_kavya", campaignId: "c_india_bfsi", name: "Kavya Nair", title: "CIO", company: "Bharat Capital",
      email: "kavya.nair@bharatcapital.in", city: "Bengaluru, IN", linkedin: "linkedin.com/in/kavyanair",
      industry: "NBFC", size: "900 employees", funding: "Listed",
      tech: ["Azure", "Kubernetes"],
      stage: "qualified", fit: 79, channel: "—",
      lastAction: "Qualified, {ago}", lastTs: hrs(5), nextStep: "Personalise & send",
    ...
    mk({
      id: "p_sam", campaignId: "c_ai_founders", name: "Sam Patel", title: "Founder", company: "VoiceForge",
      email: "sam@voiceforge.ai", city: "Austin, TX", linkedin: "linkedin.com/in/sampatel",
      industry: "Voice AI", size: "22 employees", funding: "Seed, $6M raised",
      tech: ["GCP", "Kubernetes", "WebRTC"],
      stage: "engaged", fit: 89, channel: "Email",
      lastAction: "Replied — wants to meet, {ago}", lastTs: hrs(1), nextStep: "Book meeting",
    ...
    mk({
      id: "p_tara", campaignId: "c_ai_founders", name: "Tara Novak", title: "CEO", company: "Echoloop",
      email: "tara@echoloop.ai", city: "New York, NY", linkedin: "linkedin.com/in/taranovak",
      industry: "Conversational AI", size: "35 employees", funding: "Series A, $14M raised",
      tech: ["AWS", "Redis"],
      stage: "contacted", fit: 83, channel: "SMS",
      lastAction: "SMS sent, {ago}", lastTs: hrs(3), nextStep: "Awaiting reply",
    ...
    mk({
      id: "p_jonas", campaignId: "c_ai_founders", name: "Jonas Berg", title: "Founder", company: "Lumenvoice",
      email: "jonas@lumenvoice.ai", city: "Seattle, WA", linkedin: "linkedin.com/in/jonasberg",
      industry: "Voice AI", size: "14 employees", funding: "Seed, $3M raised",
      tech: ["GCP", "Kafka"],
      stage: "qualified", fit: 86, channel: "—",
      lastAction: "Qualified, {ago}", lastTs: hrs(4), nextStep: "Personalise & send",
  ...
  const decisions = [
    D({
      id: "d1", kind: "qualified", campaignId: "c_us_saas", prospectId: "p_marcus",
      agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(2),
      headline: "Qualified — Marcus Lee, Acme Cloud",
      summary: "ICP Fitment Agent qualified **Marcus Lee**, Acme Cloud",
      evidence: [
        "Role: CTO — matches target persona",
        "Company size: 180 employees — within 50–500 range",
        'Signal: hiring "Platform Engineer, AWS cost optimisation"',
      ],
      score: 92,
      retrieved: ["ICP Definition — SaaS CTO, v2", "Case Study — Fleetwise, 23% infra cost reduction"],
    ...
    D({
      id: "d2", kind: "blocked", campaignId: "c_ai_founders", prospectId: "p_alex",
      agent: "Conflict Resolution Agent", harness: "harness v1.4", ts: hrs(1),
      headline: "Outreach blocked — Sana Corp",
      summary: "Outreach blocked — **Sana Corp** already contacted by India BFSI CIO Outreach 8h ago",
      evidence: [
        "Contact: Alex Kim, Founder — Sana Corp",
        "Prior outreach: India BFSI CIO Outreach, email, 8h ago",
        "Rule: one campaign per prospect within 14 days",
      ],
      score: 34,
      retrieved: ["Contact Policy — Cross-campaign suppression, v1"],
      instruction: "Never contact a prospect already engaged by another campaign within the last 14 days.",
      conflict: { ok: false, text: "Conflict found — outreach blocked" },
      finalAction: "Skip prospect and notify the campaign owner",
    }),
    D({
      id: "d3", kind: "meeting", campaignId: "c_india_bfsi", prospectId: "p_ananya",
      agent: "Conversation & Follow-up Agent", harness: "harness v2.1", ts: hrs(3),
      headline: "Meeting booked — Ananya Rao, Vertex Bank",
      summary: "Conversation Agent booked a meeting with **Ananya Rao**, Vertex Bank for Sep 24, 3:00 PM",
      evidence: [
        "Prospect replied asking for indicative pricing",
        "Prospect proposed a call the following week",
        "Calendar slot confirmed: Sep 24, 3:00 PM",
      ],
      score: 90,
      retrieved: ["Objection Handling Playbook — BFSI, v3", "Pricing FAQ — Regulated industries"],
    ...
    D({
      id: "d4", kind: "rejected", campaignId: "c_us_saas", prospectId: "p_leah",
      agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(5),
      headline: "Rejected — Byteform Inc.",
      summary: "ICP Fitment Agent rejected **Byteform Inc.** — company size below threshold (12 employees)",
      evidence: ["Company size: 12 employees — below the 50–500 range", "No cloud-cost hiring signal found"],
      score: 41,
      retrieved: ["ICP Definition — SaaS CTO, v2"],
      instruction: "Prioritise companies with a recent cloud-cost-related hiring signal; require 50–500 employees.",
      finalAction: "Mark as not qualified and stop outreach",
    }),
    D({
      id: "d5", kind: "enriched", campaignId: "c_us_saas",
      agent: "Lead Research & Enrichment Agent", harness: "harness v2.0", ts: hrs(9),
      headline: "Enriched — 14 new prospects",
      summary: "Lead Research Agent enriched **14 new prospects** from this week's discovery batch",
    ...
    D({
      id: "d6", kind: "qualified", campaignId: "c_us_saas", prospectId: "p_dana",
      agent: "ICP Fitment Agent", harness: "harness v3.2", ts: hrs(12),
      headline: "Qualified — Dana Priest, Fleetwise",
      summary: "ICP Fitment Agent qualified **Dana Priest**, Fleetwise (score 88/100)",
    ...
    D({
      id: "d7", kind: "strategy", campaignId: "c_us_saas", prospectId: "p_yuki",
      agent: "Personalisation & Outreach Strategy Agent", harness: "harness v4.1", ts: days(1),
      headline: "Channel chosen — Yuki Tanaka, Northwind Data",
      summary: "Personalisation Agent chose email then LinkedIn for **Yuki Tanaka**, Northwind Data",
      evidence: ["Prospect is active on LinkedIn", "Recent hiring post referencing cloud cost"],
      score: 95,
      retrieved: ["Channel Playbook — SaaS CTOs, v2"],
  ...
  const approvals = [
    A({
      id: "a_marcus", type: "followup", prospectId: "p_marcus", campaignId: "c_us_saas",
      name: "Marcus Lee", company: "Acme Cloud", tag: "Send follow-up email", tagTone: "neutral",
      summary: "Send follow-up email — **Marcus Lee**, Acme Cloud", requestedTs: m(12),
      recommendation: {
        title: "Send the pricing follow-up now — response likelihood is high.",
      ...
      draft: {
        subject: "NimbusGuard pricing + your Datadog stack",
    ...
    A({
      id: "a_ananya", type: "pricing", prospectId: "p_ananya", campaignId: "c_india_bfsi",
      name: "Ananya Rao", company: "Vertex Bank", tag: "Approve pricing disclosure", tagTone: "neutral",
      summary: "Approve pricing disclosure — **Ananya Rao**, Vertex Bank", requestedTs: m(40),
      recommendation: {
        title: "Share indicative pricing — it is needed to keep the meeting on track.",
      ...
      draft: {
        subject: "Indicative pricing for Vertex Bank",
    ...
    A({
      id: "a_sam", type: "meeting", prospectId: "p_sam", campaignId: "c_ai_founders",
      name: "Sam Patel", company: "VoiceForge", tag: "Book meeting", tagTone: "neutral",
      summary: "Book meeting — **Sam Patel**, VoiceForge", requestedTs: hrs(1),
      recommendation: {
        title: "Confirm Thursday afternoon — the founder proposed the slot.",
      ...
      draft: {
        subject: "Thursday at 3:30 PM works",
    ...
    A({
      id: "a_wei", type: "escalation", prospectId: "p_wei", campaignId: "c_us_saas",
      name: "Wei Chen", company: "CloudNet", tag: "Escalation: security objection", tagTone: "danger",
      summary: "Escalation — **Wei Chen** raised a security/compliance objection", requestedTs: hrs(2),
      recommendation: {
        title: "Respond personally — the objection needs a compliance answer.",
      ...
      draft: {
        subject: "Re: SOC 2 and data residency",
    ...
    A({
      id: "a_dana", type: "first", prospectId: "p_dana", campaignId: "c_us_saas",
      name: "Dana Priest", company: "Fleetwise", tag: "Send first outreach email", tagTone: "neutral",
      summary: "Send first outreach email — **Dana Priest**, Fleetwise", requestedTs: hrs(3),
      recommendation: {
        title: "Send the opening email — strong fit and a live hiring signal.",
      ...
      draft: {
        subject: "Cutting cloud spend at Fleetwise",
  ...
  const agents = [
    {
      id: "lead", listName: "Lead Research & Enrichment", title: "Lead Research & Enrichment Agent",
      settingsName: "Lead Research & Enrichment Agent",
      ...
      versions: [
        V("v2.0", "JD", "Sep 12", "active",
          "You are the Lead Research & Enrichment agent. Given a discovered prospect, enrich the record with company size, funding, tech stack and hiring signals from approved sources only. Never fabricate fields that are not present in the source data.",
          "JD", days(7)),
        V("v1.9", "Priya S.", "Sep 4", "archived",
          "You are the Lead Research agent. Enrich each prospect with company size and funding from approved sources. Leave unknown fields empty.", null, null),
      ],
      overrides: [],
    },
    {
      ...
      enabled: true, disabledBy: null, disabledTs: null,
      versions: [
        V("v3.2", "Priya S.", "Sep 10", "active",
          "You are the ICP Fitment agent. Score each prospect from 0 to 100 against the campaign ICP using role, company size and buying signals. Qualify at 70 or above, cite the evidence for every score, and reject any prospect that triggers an exclusion criterion.",
          "Priya S.", days(9)),
        V("v3.1", "Rohit K.", "Aug 30", "archived",
          "You are the ICP Fitment agent. Score each prospect from 0 to 100 against the campaign ICP. Qualify at 75 or above and list your reasons.", null, null),
      ],
      overrides: [],
    },
    {
      id: "personalisation", listName: "Personalisation & Outreach Strategy",
      title: "Personalisation & Outreach Strategy Agent", settingsName: "Personalisation & Outreach Strategy Agent",
      description: "Decides channel and timing, then drafts contextual outreach using retrieved knowledge.",
      enabled: true, disabledBy: null, disabledTs: null,
      versions: [
        V("v4.1", "Priya S.", "Sep 17", "active",
          "You are the Personalisation & Outreach Strategy agent for NimbusGuard's SDR system. Given a qualified prospect and retrieved knowledge, decide the best channel and timing, then draft a short, specific first message referencing one real fact about the prospect. Never fabricate details not present in the research record. Match tone to the campaign's configured voice.",
          "Priya S.", days(2)),
        V("v4.0", "Rohit K.", "Sep 14", "archived",
          "You are the Personalisation & Outreach Strategy agent. Given a qualified prospect, choose the best channel and draft a short first message that references one fact from the research record. Keep the tone consistent with the campaign.", null, null),
        V("v3.2", "Priya S.", "Sep 10", "archived",
          "You are the outreach agent. Draft a first message for each qualified prospect using the research record and the campaign tone. Keep it under 90 words.", null, null),
        V("v3.1", "JD", "Sep 6", "archived",
          "You are the outreach agent. Draft a short first message for each qualified prospect and pick email unless the campaign says otherwise.", null, null),
      ],
      overrides: [
    ...
    {
      id: "conversation", listName: "Conversation & Follow-up", title: "Conversation & Follow-up Agent",
      settingsName: "Conversation & Follow-up Agent",
      description: "Handles replies and follow-ups, detects objections, and escalates to a human when needed.",
      enabled: true, disabledBy: null, disabledTs: null,
      versions: [
        V("v2.1", "Rohit K.", "Sep 13", "active",
          "You are the Conversation & Follow-up agent. Reply to prospects using retrieved knowledge, propose a meeting once intent is clear, and escalate to a human on any pricing, security or compliance objection. Never make commitments that are not in the knowledge base.",
          "Rohit K.", days(6)),
        V("v2.0", "Priya S.", "Sep 2", "archived",
          "You are the Conversation agent. Reply to prospects using retrieved knowledge and escalate objections to a human.", null, null),
      ],
      overrides: [
        { campaignId: "c_india_bfsi", text: "Escalate any regulatory or data-residency question to a human.", ts: days(5) },
      ],
    },
    {
      ...
      versions: [
        V("v1.2", "JD", "Sep 9", "active",
          "You are the Voice SDR agent. Follow the approved call script exactly, confirm the prospect's identity, and offer to schedule a meeting. Never discuss pricing on a call; hand off to a human instead.",
          "JD", days(10)),
        V("v1.1", "JD", "Aug 28", "archived",
          "You are the Voice SDR agent. Follow the approved call script and offer to schedule a meeting.", null, null),
      ],
      overrides: [],
    },
  ];
  ...
  // STUB: integrations are always reported as connected until the backend exposes real status.
  const integrations = [
    "Claude (Sonnet)", "Gmail API", "Twilio", "Apollo", "DronaHQ Agentic AI", "pgvector (RAG)",
