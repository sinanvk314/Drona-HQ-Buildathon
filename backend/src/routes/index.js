...
router.get("/campaigns/:id/blueprint", asyncRoute(async (req, res) => res.json(data.getBlueprint(req.params.id))));
router.post("/campaigns/:id/persona", asyncRoute(async (req, res) => res.json(data.setCampaignPersona(req.params.id, req.body || {}))));
